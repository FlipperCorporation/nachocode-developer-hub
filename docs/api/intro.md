...
nachocode 플랫폼의 앱 유저 관리 서비스를 통해 광고성 푸시, 세그먼트 푸시 설정이 가능합니다.
...
- **회원 탈퇴**
  ...
  :::info 회원 탈퇴
  ➡️ [회원 탈퇴 API](./app-user/user-preferences.endpoints#delete-app-user-v2) 바로가기
  :::
...
- **광고성 푸시 알림 수신 동의 변경**
  ...
  :::info 유저 마케팅 동의
  ➡️ [마케팅 동의 API](./app-user/user-preferences.endpoints#delete-app-user-v2) 바로가기
  :::
