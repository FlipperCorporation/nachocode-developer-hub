...
nachocode 회원 상태 관리 API를 활용하여 회원 상태를 관리 할 수 있습니다.
...
- 유저와 보유중인 모든 디바이스의 **설정 또는 동의 여부를 초기화**합니다.
- **회원 탈퇴**의 상황에 사용하기 적합합니다.
...
- **Error Response**
  ...
  - 에러코드
    ...
    | ------------- | --------------- | --------------------------------------------- | -------------------------------------- |
    | ERR-AB-ACS-21 | 403             | This app is unable to handle user preference. | 유저 동의값 관리 기능이 사용 불가한 앱 |
