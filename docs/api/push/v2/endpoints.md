...
:::info
토큰이 없거나, 토큰 만료 또는 앱 삭제의 이유로 전송 불가한 유저의 목록은 [**웹훅**](../../../guide/webhook/overview)을 통해서만 확인할 수 있습니다.
:::
...
:::tip
토큰이 없거나, 토큰 만료 또는 앱 삭제의 이유로 전송불가한 유저의 목록을 [**웹훅**](../../../guide/webhook/overview.md)을 통해 확인할 수 있습니다.
:::
