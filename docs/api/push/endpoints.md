...
- **Detail Description**
  ...
  | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | isUsingBadge  | 이 설정은 플랫폼(android, ios)에 따라 동작 방식에 차이가 있습니다. <br/><br/> [**Android**] <br/> OS레벨에서 뱃지 기능을 자동으로 처리하므로, `isUsingBadge`설정값과 관계없이 android정책에 따라 알림 뱃지가 자연스럽게 표시됩니다. <br/><br/> [**iOS**] <br/> 알림이 하나 이상 도착하면 앱 아이콘에 '**1**'이 표시되고, 실제 알림 개수와 관계없이 뱃지 숫자가 항상 '**1**'로 표시됩니다. <br/> 이는 **푸시가 도착했음을 표시**하는 용도로 활용 가능하며, 알림 건수 누적 기능의 경우 추후 업데이트 예정입니다. |
