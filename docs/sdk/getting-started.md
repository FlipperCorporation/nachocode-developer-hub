...
- 로거에서 브라우저에 출력하는 로그는 **샌드박스 앱** 환경에서 확인이 가능합니다.

:::tip **SDK 로그를 확인하는 방법**
➡️ [**샌드박스 가이드** 바로가기](/docs/guide/sandbox/sandbox-overview)
:::
...
nachocode Client SDK 초기화 완료 시점은 두 가지 방식으로 감지할 수 있습니다.
