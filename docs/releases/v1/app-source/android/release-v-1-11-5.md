---
sidebar_label: 'ver.1.11.5 (26.08.26)'
description: nachocode Android App Source ver.1.11.5의 릴리즈노트입니다.
image: /img/docs/releases/release_note_android_detail.png
---

# Release: ver.1.11.5 (2026-08-26)
...
nachocode Android AppSource **ver.1.11.5**의 변경 사항을 앱에 반영하려면 아래 경로에서 신규 버전의 앱을 다시 빌드하여 적용 가능합니다.
