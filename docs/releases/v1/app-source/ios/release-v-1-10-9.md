...
nachocode iOS App Source **1.10.9** 버전이 반영되었습니다.

이번 업데이트 **ver.1.10.9**에서는 앱 코드가 개선되었습니다.

## 개선 및 수정 사항

- **쿠키 복원** : 쿠키 복원 순서가 변경되었습니다.

## 업데이트 적용 방법

nachocode iOS AppSource **ver.1.10.9**의 변경 사항을 앱에 반영하려면 아래 경로에서 신규 버전의 앱을 다시 빌드하여 적용 가능합니다.
