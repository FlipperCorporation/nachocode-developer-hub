...
nachocode iOS App Source **1.8.3** 버전이 반영되었습니다.

이번 업데이트 **ver.1.8.3**에서는 일부 버그가 수정되었습니다.
...
nachocode iOS AppSource **ver.1.8.3**의 변경 사항을 앱에 반영하려면 아래 경로에서 신규 버전의 앱을 다시 빌드하여 적용 가능합니다.
